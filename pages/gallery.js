...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
    ...
    <div class="grid gap-4">
        <div>
            <img class="h-auto max-w-full rounded-lg" src="salman.jpg" alt=""/>
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="eye.jpg" alt=""/>
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="mata.jpg" alt=""/>
        </div>
